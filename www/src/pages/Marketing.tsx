...
const Marketing = () => {
    ...
    return (
        <>
            ...
            <div className="flex w-full justify-evenly items-center h-[calc(100vh-100px)]">
                <div className="flex flex-col gap-10">

                    <div className="flex gap-4 bg-zinc-900 w-96 rounded-xl p-3 items-center">
                        <input type="checkbox" />
                ...
                <img className="w-96 rounded-xl" src="generatedTweet.png" />
            </div>
